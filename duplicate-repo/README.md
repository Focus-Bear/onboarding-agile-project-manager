...
```sh
 git clone https://github.com/Focus-Bear/onboarding-agile-project-manager.git
 cd onboarding-agile-project-manager
```
...
2. Open `.env` and edit the following:
   ...
   SOURCE_REPO=Focus-Bear/onboarding-agile-project-manager
